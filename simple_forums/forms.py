...
class ForumMessageEditForm(forms.ModelForm):
    body = forms.CharField(label='Post Body', widget=MarkdownWidget)
    class Meta:
...
class ThreadReplyForm(forms.Form):
    ...
    body = forms.CharField(label='Reply', widget=MarkdownWidget)
